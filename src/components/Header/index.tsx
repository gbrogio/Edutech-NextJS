...
const Header: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!isNav) { //  se a navegação esquerda for falsa
      ...
      document.documentElement.style.overflowY = 'auto'; // habilita o scroll da pagina
      ...
      document.documentElement.style.overflowY = isWidth < 425 ? 'hidden' : 'auto'; // retira o scroll da pagina
